...
export default defineConfig({
  title: "YuPi AI 지식베이스",
  description:
    "YuPi AI 지식베이스 - 무료 DeepSeek 튜토리얼｜도구 사이트｜리소스 라이브러리, 원스톱 오픈소스 무료 인공지능 지식 공유 플랫폼입니다. Deepseek, GPT 등 인기 AI 도구 소개, 사용 가이드, 팁 공유, 활용 사례, AI 수익화, 업계 뉴스, 튜토리얼 리소스 모음을 제공하며, 체계적인 AI 튜토리얼과 엄선된 AI 리소스를 제공하여 여러분이 AI 기술을 빠르게 마스터하고 AI 전문가가 되도록 돕습니다!",
  head: [
    // 站点图标
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "ai, deepseek, AI 뉴스, 인공지능, AI 업계 트렌드, AI 기술, AI 소식, AI 동향, AI 시장 분석, AI 모델, AI 독점 분석, AI 심층 해석",
      },
    ],
    // 百度统计
    [
